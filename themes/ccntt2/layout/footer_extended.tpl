    ...
    <div class="container">
        <div class="row">
            <div class="wraper clearfix">
                ...
                <div class="col-xs-24 col-sm-24 col-md-10 text-left">[FEATURED_PRODUCT]</div>
                <div class="col-xs-24 col-sm-24 col-md-12">[COMPANY_INFO]</div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-24 col-sm-24 col-md-8">
                <div class="qr-code-wraper">[QR_CODE]</div>
                <div id="ftip" data-content="">
                    <div class="bg"></div>
                </div>
            </div>
            <div class="col-xs-24 col-sm-24 col-md-16">[FOOTER_SITE]</div>
        </div>
    </div>
</footer>
